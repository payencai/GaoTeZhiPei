...
public class ChooseAddressWebActivity extends AppCompatActivity implements PermissionUtils.ApplyPermission {
    ...
    private void requestPermissions() {
        ...
        PermissionUtils.needPermission(ChooseAddressWebActivity.this, needPermissions, 100);
    }
...
//                WebViewActivity.this.finish();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        PermissionUtils.onRequestPermissionsResult(ChooseAddressWebActivity.this, requestCode, permissions, grantResults);
