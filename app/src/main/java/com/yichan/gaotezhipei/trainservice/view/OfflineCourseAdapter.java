...
public class OfflineCourseAdapter extends MSClickableAdapter<OfflineCourseAdapter.CourseListViewHolder> {

    private List<OfflineCoursePage.BeanListBean> mList;
    private Context mContext;

    public OfflineCourseAdapter(List<OfflineCoursePage.BeanListBean> mList, Context mContext) {
        this.mList = mList;
