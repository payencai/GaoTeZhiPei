...
public class ConsultPage {
    ...
    /**
     * beanList : [{"content":"string","createTime":"2018-03-07T10:59:01.681Z","id":"string","image":"string","imageKey":"string","isDel":0,"isUse":0,"title":"string"}]
     * pageNum : 0
     * pageSize : 0
     * tp : 0
     * tr : 0
    ...
    public static class BeanListBean {
        /**
         * content : string
         * createTime : 2018-03-07T10:59:01.681Z
         * id : string
         * image : string
         * imageKey : string
         * isDel : 0
